  ...
  <div class="frm-news">
    ...
    <div class="container-news">
      <div v-for="expert in 6" :key="expert">
        <table class="news">
          <tr border="5">
            <td colspan="2" class="text-news" >This is a title of the news This is a title of the news This is a title of the news</td>
          </tr>
          <tr>
            <td rowspan="2" class="img-new1">   <img
          src="/field.jpg"
          alt=" 'image'"
          class="img-news"
        /></td>
            <td class=" textsub">This is the sub-detail of news. This is a title of the news This is a title of the news This is a title of the news This is a title of the news</td>
