<template>
  ...
  <div class="frm-quest">
    <div class="title-quest">FQAs</div>
  ...
  <div class="frm-input">
    <div class="title-quest">Your Question</div>
    <div class="container-quest">
      <input type="text" placeholder="Enter your question" class="input-quest">
    </div>
  </div>
</template>
