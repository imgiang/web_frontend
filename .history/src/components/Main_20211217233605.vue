<template>
  ...
  <div class="frm-field">
    ...
    <div class="container-field">
      <div>
        <img src="/assets/Fields/architect.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Architect</div>
      </div>
      <div>
        <img src="/Astronomy.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Astronomy</div>
      </div>
      <div>
        <img src="/beauty salon.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Beauty salon</div>
      </div>

      <div>
        <img src="/biology.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Biology</div>
      </div>
      <div>
        <img src="/business.jpg" alt=" 'image'" class="img-field" />
      ...
      <div>
        <img src="/dentist-office-min.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Dentist-office-min</div>
      </div>
      <div>
        <img src="/education.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Education</div>
      </div>
      <div>
        <img src="/infotech.jpg" alt=" 'image'" class="img-field" />
        <div class="text-field">Infotech</div>
      </div>
      <div>
        <img src="/restaurant.jpg" alt=" 'image'" class="img-field" />
...
.container-expert {
  ...
  margin-right: 30px;
  display: grid;
  grid-template-columns: 320px 330px 330px 320px;
...
.container-field {
  ...
  /* margin-right: 30px; */
  display: grid;
  grid-template-columns: 390px 410px 390px;
